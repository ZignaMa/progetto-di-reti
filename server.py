# -*- coding: utf-8 -*-
"""
Created on Mon May 27 12:39:37 2024
...
def connessioniInEntrata():
    ...
    while True:
        try:
            ...
            Thread(target=gestisceClient, args=(client,)).start()
...
if __name__ == "__main__":
    ...
    accept_thread = Thread(target=connessioniInEntrata)
    accept_thread.start()
    accept_thread.join()
